...
void printShaderInfoLog(GLuint obj) {
    ...
    if (infologLength > 0) {
        ...
        // glGetShaderInfoLog ʧX Returns the information log for a shader
        // object
        printf("%s\n", infoLog);
        free(infoLog);
    }
...
void printProgramInfoLog(GLuint obj) {
    ...
    if (infologLength > 0) {
        ...
        // glGetProgramInfoLog ʧX Returns the information log for a program
        // object
        printf("%s\n", infoLog);
        free(infoLog);
    }
...
GLuint CreateShaders(std::string vertPath, std::string fragPath) {
